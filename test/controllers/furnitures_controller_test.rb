...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference("furniture.count") do
      post furnitures_url, params: { furniture: { address: @furniture.address, name: @furniture.name } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { address: @furniture.address, name: @furniture.name } }
